...
parser.add_argument("--query", "-q", help="query sequence file", type=str)
parser.add_argument("--subject", "-s", help="subject sequence file", type=str)
parser.add_argument("--sequences_database", "-f", help="SPAdes contigs file (or any sequences file in FASTA format)", type=str)
