...
# chmod u+x DraftPolisher_cov.py
# # input files format:
# >QRY
# draft sequence
# >SBJ
    ...
    for i in pos:
        ...
        if i + 34 <= ln:
            if ja[i - 8] == "_" or ja[i - 7] == "_" or ja[i - 6] == "_" or ja[i - 5] == "_" or ja[i - 4] == "_" or ja[
                ...
                i - 3] != "_" or ja[i - 2] != "_" or ja[i - 1] != "_" or ja[i] != "_" or ja[i + 1] != "_" or ja[
                i + 2] != "_" or ja[i + 3] != "_" or ja[i + 4] != "_" or ja[i + 5] != "_" or ja[i + 6] != "_" or ja[i + 7] \
                    != "_" or ja[i + 8] != "_":
                print(ja[i - 8], ja[i - 7], ja[i - 6], ja[i - 5], ja[i - 4], ja[i - 3], ja[i - 2], ja[i - 1], ja[i],
                      ja[i + 1], ja[i + 2], ja[i + 3], ja[i + 4], ja[i + 5], ja[i + 6], ja[i + 7], ja[i + 8],
                      file=open("oligob.txt", "a+"), sep="")
...
answer = input("Do you want to keep process files (default=False)? If no, all the files inside the working dir will be destroied exept the output file [yes/no]: ")
if answer == "yes":
